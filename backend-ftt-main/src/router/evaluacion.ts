...
router.get(
  "/promedios/:fechaDesde/:fechaHasta/:cCajero",
...
router.get(
  "/maximosminimos/:fechaDesde/:fechaHasta/:cCajero",
  (req: Request, res: Response) => {
    const fDesde = req.params.fechaDesde;
    const fHasta = req.params.fechaHasta;
    const cCajero = req.params.cCajero;
...
router.get(
  "/promediose/:fechaDesde/:fechaHasta/:cCajero",
  (req: Request, res: Response) => {
    const fDesde = req.params.fechaDesde;
    const fHasta = req.params.fechaHasta;
    const cCajero = req.params.cCajero;
...
router.get(
  "/maximosminimose/:fechaDesde/:fechaHasta/:cCajero",
  (req: Request, res: Response) => {
    const fDesde = req.params.fechaDesde;
    const fHasta = req.params.fechaHasta;
    const cCajero = req.params.cCajero;
...
router.get("/graficobarras", (req: Request, res: Response) => {
  const query =
    `
...
router.get(
  "/graficobarrasfiltro/:fechaDesde/:fechaHasta/:cCajero",
  (req: Request, res: Response) => {
    const fDesde = req.params.fechaDesde;
    const fHasta = req.params.fechaHasta;
    const cCajero = req.params.cCajero;
...
router.get(
  "/establecimiento/:fechaDesde/:fechaHasta/:empresa",
  (req: Request, res: Response) => {
    const fDesde = req.params.fechaDesde;
    const fHasta = req.params.fechaHasta;
    const cEmpresa = req.params.empresa;
...
router.get(
  "/evaluaciongrupos/:fechaDesde/:fechaHasta/:cCajero",
  (req: Request, res: Response) => {
    const fDesde = req.params.fechaDesde;
    const fHasta = req.params.fechaHasta;
    const cCajero = req.params.cCajero;
