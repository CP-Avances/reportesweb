...
router.get("/evaluacion/omitidas/resumen/:fechaDesde/:fechaHasta/:horaInicio/:horaFin/:servicios/:sucursales/:subservicio/:cajero/:opcion/:estado/:fecha", verifivarToken_1.TokenValidation, (req, res) => {
    // VARIABLES DE FECHAS
    const fDesde = req.params.fechaDesde;
    const fHasta = req.params.fechaHasta;
    // VARIABLES DE HORAS
    ...
    if (!diaCompleto)
        filtros += ` AND ne.eval_hora BETWEEN '${hInicio}' AND '${hFinAux}' `;
